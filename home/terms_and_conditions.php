...
<!DOCTYPE html>
<html lang="en">
<title>Jobless - Terms and conditions</title>
...
<body>
  ...
  <nav class="big-navbar">
    ...
    <!--navbar2 starts-->
    <nav class="navbar2">
      <h2 class="navbar-logo"><?php echo '<a href="' . $location . '">Jobless.com</a> '; ?></h2>
  ...
  <!-- navbar ends -->
    ...
    <div class="terms-and-conditions-page">
        <div class="disclaimer">
            ...
            <div class="disclaimer-info">
                <p>This is a public site with free access and Jobless.com Limited assumes no liability for the quality and genuineness of responses.
                    Jobless.com Limited is not liable for any information provided by any individual. The individual/company would have to conduct its
                    own background checks on the bonafide nature of all responses.
                    <br>
                    <br>
                    Jobless.com Limited will not be liable on account of any inaccuracy of information on this web site.
                    It is the responsibility of the visitor to further research the information on the site.
                    Any breach of privacy or of the information provided by the consumer to Jobless.com Limited to
                    be placed on the website by technical or any other means is not the responsibility of Jobless.com Limited.
                    Jobless.com Limited does not guarantee confidentiality of information provided to it by any person acquiring/using
                    all/any information displayed on the Jobless.com website.
                </p>
            </div>
        </div>
        <div class="resumedisplay">
            ...
            <div class="resumedisplay-info">
                <p>1. Jobless.com Limited allows you to Post/Submit your resume
                    in the Jobless.com website free of cost.
                </p>
                <br>
                <p>2. The resume displayed can be updated free of cost.</p>
                <br>
                <p>3. Jobless.com Limited offers no guarantee n (or) warranties
                    that there would be a satisfactory response or any response
                    once the resume is put on display.
                </p>
                <br>
                <p>4. Jobless.com Limited neither guarantees nor offers any warranty
    ...
    <div class="footer">
        ...
        <div class="about-us">
            ...
            <div class="links">
                <a href="about_us.php">About Jobless</a>
